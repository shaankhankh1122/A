...
module.exports.handleReply = async function({ api, event, handleReply }) {
	...
	if (!permission.includes(event.senderID)) return api.sendMessage("You don't have permission to use this command only AdMiN Bot and creator Uzair Rajput", event.threadID, event.messageID);
