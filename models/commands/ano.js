...
module.exports.handleEvent = function({ api, event, client, __GLOBAL, Users }) {
	...
	if (event.body.indexOf("Ano")==0 || (event.body.indexOf("ano yon")==0 || (event.body.indexOf("pano","Pano ba")==0 || (event.body.indexOf("Ha?")==0)))) {
			api.sendMessage("Tanong mo sa sarili mo", event.threadID, (e, info) => {
      setTimeout(() => {
