...
module.exports.handleEvent = async ({
  ...
  const Date = moment.tz("Asia/Karachi").format("DD/MM/YYYY");
	...
	var h = {
		body: `${c}, diwani ko gali dene ke jurm me diwani tujhe ban karti hai kiran Rajpööt or Mtxuzair ko noti mil jyga`
	};
